...
# from Non_local.lib.non_local_embedded_gaussian_MPN import NONLocalBlock2D_MPN
from Models.ASPNet import ASPNet
from MPNCOV.python.MPNCOV import CovpoolLayer
import torch
...
def resnet20_ASP(**kwargs):
    model = ResNet(BasicBlock, 3, **kwargs)
    return model


def resnet32_ASP(**kwargs):
    model = ResNet(BasicBlock, 5, **kwargs)
    return model


def resnet56_ASP(**kwargs):
